...
let optionsshaders_low = `
#Wed Jan 08 02:50:06 NZDT 2020
shaderPack=OFF
antialiasingLevel=2
...
biomeBlendRadius:2
renderClouds:false
resourcePacks:["mod_resources","vanilla","file/Hegemony.zip"]
incompatibleResourcePacks:[]
lastServer:mc.hegemony.xyz
lang:en_nz
chatVisibility:0
...
let optionsshaders_ultra = `
#Sun Dec 29 00:40:40 NZDT 2019
shaderPack=seus.zip
antialiasingLevel=2
normalMapEnabled=true
specularMapEnabled=true
...
function setupGraphics() {
  setActiveGraphics(ConfigManager.getGraphicsSetting());
  document.getElementById("settingsGameGraphicsContentButtonLow").onclick = e =>
    setActiveGraphics("low");
  document.getElementById(
    "settingsGameGraphicsContentButtonMedium"
  ).onclick = e => setActiveGraphics("medium");
  document.getElementById(
    "settingsGameGraphicsContentButtonHigh"
  ).onclick = e => setActiveGraphics("high");
  document.getElementById(
    "settingsGameGraphicsContentButtonUltra"
  ).onclick = e => setActiveGraphics("ultra");
}
...
function setActiveGraphics(active) {
  // Reset selection
  document
    .getElementById("settingsGameGraphicsContentButtonLow")
    .classList.remove("btn-active");
  document
    .getElementById("settingsGameGraphicsContentButtonMedium")
    .classList.remove("btn-active");
  document
    .getElementById("settingsGameGraphicsContentButtonHigh")
    .classList.remove("btn-active");
  document
    .getElementById("settingsGameGraphicsContentButtonUltra")
    .classList.remove("btn-active");
  switch (active) {
    case "low":
      document
    ...
    case "ultra":
      ...
      overwriteFile(
        ...
        optionsshaders_ultra
      );

      break;
  }
  // ConfigManager.setGraphicsSetting(active.toLowerCase());
  updateGraphicsSetting(active.toLowerCase());
}
