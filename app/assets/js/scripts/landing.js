...
const graphics_selection_button = document.getElementById(
  "graphics_selection_button"
);
...
function updateGraphicsSetting(settings) {
  // TODO: Implement these
  ConfigManager.setGraphicsSetting(settings);
  ConfigManager.save();
  graphics_selection_button.innerHTML = `Graphics Settings: ${settings.toUpperCase()}`;
}
// TODO: Implement this
updateGraphicsSetting(ConfigManager.getGraphicsSetting());
// updateGraphicsSetting("normal");

graphics_selection_button.onclick = e => {
  e.target.blur();
  prepareSettings();
  switchView(getCurrentView(), VIEWS.settings);
};
    ...
    if (m.context === "validateJava") {
      if (m.result == null) {
        ...
        setOverlayContent(
          ...
          'In order to join Hegemony, you need a 64-bit installation of Java 8. Would you like us to install a copy? By installing, you accept <a href="http://www.oracle.com/technetwork/java/javase/terms/license/index.html">Oracle\'s license agreement</a>.',
          "Install Java",
          "Install Manually"
        );
        setOverlayHandler(() => {
      ...
      if (login && allGood) {
        ...
        const gameStateChange = function(data) {
          ...
          if (SERVER_JOINED_REGEX.test(data)) {
            ...
            DiscordWrapper.updateDetails("Joining Hegemony!");
          }
        };
