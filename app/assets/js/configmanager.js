...
const sysRoot =
  ...
  (process.platform == "darwin"
    ...
    : process.env.HOME);
// TODO change
const dataPath = path.join(sysRoot, ".hegemonymc");
...
exports.getGraphicsSetting = function() {
  try {
    let value = config.settings.game.graphicsSetting;
    return !value ? "medium" : value;
  } catch (ignored) {}
  return "medium";
};

exports.setGraphicsSetting = function(setting) {
  config.settings.game.graphicsSetting = setting;
};
